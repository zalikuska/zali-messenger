...
- `Windows/` - Rust desktop shell;
- `Core/` - shared Rust core;
- `ZaliArchiverSDK/` - низкоуровневый SDK для `.zali`;
...
- `src/main.rs` - main server application, DB schema, routes, WS, device/vault/history logic.
