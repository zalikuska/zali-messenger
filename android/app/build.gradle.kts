...
// Copy the shared web bundle (produced by `python3 bundle_web.py`) into assets
// before every build, so the WebView always loads the current UI.
val copyWebAssets by tasks.registering(Copy::class) {
    from(rootProject.projectDir.parentFile.resolve("Web")) {
