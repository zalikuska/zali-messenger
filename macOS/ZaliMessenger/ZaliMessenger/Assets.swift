...
<body>
                            ...
                            <div class="settings-grid">
                                ...
                                <div class="settings-column">
                                    ...
                                    <section class="settings-card">
                                        ...
                                        <div class="settings-stack">
                                            <input type="url" id="inputApiBaseUrl" class="settings-input" placeholder="https://msgs.zalikus.org">
                                            <input type="url" id="inputWsBaseUrl" class="settings-input" placeholder="wss://msgs.zalikus.org/ws">
    ...
    <script src="app.js?v=mobile-20260601"></script>
<script>
// --- MODULE: bus.js ---
class ZaliBus {
    constructor() {
